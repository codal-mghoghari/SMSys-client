...
import userController, {loginUser, registerUser} from "../../../controller/userController";
        ...
        <div>
            ...
            <div className="relative top-24 left-[15%]">
                <div id="loginContainer"
                        ...
                        >
                            {({
                                ...
                                <form method="post" onSubmit={handleSubmit}
                                    ...
                                    <a className="text-sm group transition duration-300" href="#">Forgot your
                                        password?
                                        <span
                                    ...
                                    <button
                                        type="submit"
                                        className="rounded-full w-2/4 text-xs bg-red-500 border text-white border-solid border-red-500 font-bold py-3 px-2 tracking-wider uppercase transition-transform duration-[80ms] ease-in active:scale-[0.95]">Login
                                    </button>
                                </form>
                            )}
                        </Formik>
                    ...
                    <div
                        className="flex flex-col bg-red-500 w-2/4 text-center p-10 justify-center items-center rounded-r-2xl">
                ...
                <div id="registerContainer"
                    ...
                    <div
                        className="flex flex-col bg-red-500 w-2/4 text-center p-10 justify-center items-center rounded-l-2xl">
                        <div className="flex flex-col text-center gap-5 justify-center items-center">
                        ...
                        >
                            {({
                                ...
                                <form method="post" onSubmit={handleSubmit}
                                    ...
                                    <button
                                        type="submit"
                                        className="rounded-full w-2/3 text-xs bg-red-500 border text-white border-solid border-red-500 font-bold py-3 px-2 tracking-wider uppercase transition-transform duration-[80ms] ease-in active:scale-[0.95]">Register
                                    </button>
                                </form>
                            )}
                        </Formik>
