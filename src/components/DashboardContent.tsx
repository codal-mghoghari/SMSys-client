...
export const DashboardContent = (props: {
    ...
    return (
        <>
            <AllCourses allQuizData={quizJsonData} quizCats={quizCats} btnHandler={props.clickHandler} />
                    ...
                    <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
...

                        {
                            toggleBtn === "account" ? (
                                ...
                                <div id="settings"
                                     className="relative col-span-8 h-[28rem] overflow-x-hidden overflow-y-auto rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
                                    <div
