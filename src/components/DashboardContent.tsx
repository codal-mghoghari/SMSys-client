...
import {getKeysWithValueTrue} from "@/util/Util";
...
export const DashboardContent = (props: {
    ...
    const optedCourses = JSON.parse(props.userData.optedCourses!)
    const optedUserCourses = getKeysWithValueTrue(optedCourses)

    return (
        <>
            <div className="relative">
                <main id="user" className="max-w-full h-full flex relative overflow-y-hidden">
                ...
                <main id="settings" className="absolute top-0 left-0 invisible">
                                ...
                                <ul>
                                    <li
                                        ...
                                        onClick={(e) => {
                                            ...
                                            document.getElementById('account')!.classList.add
                                            ("border-l-custom-border-primary")
                                        }}
                                    ...
                                    <li className="mt-5 border-l-2 border-transparent px-2 py-2 font-normal">More Coming
                                        soon..
                                    </li>
                                </ul>
                            </div>
                                ...
                                toggleBtn === "account" ? (
                                    <div id="account"
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <p className="mt-2">Make sure you have taken backup of your account in case
                                                you ever
                                    ...
                                    <div id="settings"
                                         className="relative col-span-8 h-[28rem] overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
                                        <div
